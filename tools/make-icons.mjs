#!/usr/bin/env node
// PWA ikony z oficiálnej striešky PRIMA: plná PRIMA červená #EE2A24 + biela strieška (manuál:
// biele logo na červenej áno, gradient nie). Rasterizuje sa
...
const ROOF = '<path d="M113.53 26.51L340.17 136.39V109.87L140.88 13.26L113.53 26.51Z" fill="#FFFFFF" fill-opacity="0.78"/><path d="M101.7 5.74L0.459656 54.82V81.33L113.53 26.51L140.88 13.26L113.53 0L101.7 5.74Z" fill="#FFFFFF"/>';
...
const icon = (pad, radius) => {
  ...
  return `<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512"><rect width="512" height="512" rx="${radius}" fill="#EE2A24"/><g transform="translate(${pad} ${y}) scale(${s})">${ROOF}</g></svg>`;
};
